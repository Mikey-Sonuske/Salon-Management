...
if (strlen($_SESSION['bpmsaid'] == 0)) {
	...
	if (isset($_POST['submit'])) {
		...
		$query = mysqli_query($con, "update  tblservices set ServiceName='$sername',ServiceDescription='$serdesc',Cost='$cost' ,Discount='$discount' where ID='$eid' ");
		if ($query) {
									...
									?>
										...
										<div class="form-group">
											...
											<input type="number" class="form-control" id="discount" name="discount"
												value="<?php echo $row['Discount']; ?>" min="0" max="100">
										</div>
